...
jboolean Java_com_example_position2shp_Util_TestUtils_updateShapefile(JNIEnv * env, jclass clazz,
...
jboolean Java_com_example_position2shp_Util_TestUtils_createShapefile(JNIEnv * env, jclass clazz,
                                                                           jstring file, jobject listObject) {
...
void process(JNIEnv * env, SHPHandle hSHP, DBFHandle hDBF, jstring file, jobject listObject) {
    jclass classAdapter = (*env)->FindClass(env, "com/example/position2shp/Util/TestUtils$DataAdapter");
    ...
    // Apple tree
    jclass classAppleTree = (*env)->FindClass(env, "com/example/position2shp/Util/TestUtils$AppleTree");
